...
export default class AddSegmentation extends React.Component {
    ...
    onEditSubmit(evt, skipValidation = false) {
        ...
        //    validateMicrosegmentationPolicy(category, roleMembers, inboundDestinationService, outboundSourceService, sourcePort, destinationPort, protocol, skipValidation) {
        this.validateMicrosegmentationPolicy(
            this.props.category,
            this.state.members,
            this.state.inboundDestinationService,
