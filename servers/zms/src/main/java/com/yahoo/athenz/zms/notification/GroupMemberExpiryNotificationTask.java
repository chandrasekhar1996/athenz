    ...
    public static class GroupExpiryDomainNotificationToSlackConverter implements NotificationToSlackMessageConverter {
        ...
        private String getDomainExpirySlackMessage(Map<String, String> metaDetails) {
            ...
            for (String member: members) {
                ...
                groupMap.put("group", roleName);
                groupMap.put("member", memberDetails[2]);
                groupMap.put("expiration", memberDetails[3]);
                groupMap.put("notes", memberDetails[4]);

                groupMap.put("groupLink", notificationConverterCommon.getGroupLink(domainName, roleName));
